...
// This script is analysing the manifest.json file
// looking for the outputs/keys and putting them into .env
...
module.exports = async function processManifest(manifestData) {
  ...
  await updateDotEnv(dotEnvFile, {
    API_URL: getOutputValue("ZuhausliveappsyncGraphQlApiUrl"),
  });
};
